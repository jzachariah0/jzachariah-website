...
/**
 * Stripe-like layered wave - accent blue only.
...
function WaveBand({
  ...
  return (
    ...
    >
      ...
      >
        {/* Two identical periods in one SVG - no seam between flex tiles */}
...
export function ContactWave({ className = "" }: { className?: string }) {
  ...
  return (
    <div
      ...
      aria-hidden
      style={{
        // Fade only the wave itself - never a white sheet over page copy
        maskImage:
